package com.example.mallordergraphserver.tools;


import com.example.mallordergraphserver.config.OrderMcpNodeProperties;
...
public class MallMcpClientToolCallbackProvider {
    ...
    public Set<ToolCallback> getToolCallbacks(String nodeName) {
        ...
        Set<String> mcpClients =orderMcpNodeProperties.getNode2servers().get(nodeName);
